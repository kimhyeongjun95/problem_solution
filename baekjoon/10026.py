...
# queue = ([])
# visted 위 # VISITED 안되있기 때문에 이미 APPEND된곳을 다시 APPEND한다.
# visted 아래 # APPEND할때부터 이미 VISITED가 돼있어서 다시 APPEND안한다
# # 00010
# # 00111
# # 00000
# # 11111
...
def area_count(x, y):
    ...
    while stack:
        x, y = stack.pop()
        color = arr[x][y] # 방문
        # visited로 탐색했기때문에 // 밑에 if문에서 검색하기때문에 append안함
        for dx, dy in dxy:
            nx = x + dx
            ny = y + dy
